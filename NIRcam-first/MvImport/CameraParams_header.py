...
_MV_CC_LIQUIDLENS_RANGE_SCAN_PARAM_._fields_ = [
    ('nFocalPowerStart', c_int),                ## @~chinese  起始光焦度值 范围[INT16_MIN, INT16_MAX]               @~english Start focal power value, range[INT16_MIN, INT16_MAX]
    ('nFocalPowerEnd', c_int),                  ## @~chinese  结束光焦度值  范围[INT16_MIN, INT16_MAX]              @~english End focal power value, range[INT16_MIN, INT16_MAX]
...
_MV_CC_LIQUIDLENS_MULTI_FP_SCAN_PARAM_._fields_ = [
    ...
    ('nFocalPowers', c_int * 32),                      ## @~chinese 光焦度数组,光焦度数值范围[INT16_MIN, INT16_MAX]       @~english Focal power array, focal power value range[INT16_MIN, INT16_MAX]
...
__all__ = ['_MV_ALL_MATCH_INFO_', 'MV_CC_FILE_ACCESS_PROGRESS',
           ...
           'MV_CC_LIQUIDLENS_EXCEPTION_OFFLINE',
           'MV_CC_LIQUIDLENS_DEFALUT','MV_CC_LIQUIDLENS_USERSET1','MV_CC_LIQUIDLENS_USERSET2','MV_CC_LIQUIDLENS_USERSET3',
